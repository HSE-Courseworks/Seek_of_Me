...
public class BossWeapon : MonoBehaviour {
	...
	void Shoot()
	{
		Vector3 weaponRotation = transform.rotation * Vector3.forward;
		Vector2 firePointPosition = new Vector2(firePoint.position.x, firePoint.position.y);
		RaycastHit2D hit = Physics2D.Raycast(firePointPosition, weaponRotation);

		Debug.DrawLine(firePointPosition, weaponRotation * 100, Color.cyan);
